...
app.config['JWT_SECRET_KEY'] = 'seu-segredo-aqui-123456'
...
def signup():
    ...
    if not data or not data.get('username') or not data.get('email') or not data.get('password'):
        return jsonify({'error': 'Username, email e password são obrigatórios'}), 400 # Bad Request - dados faltando ou inválidos
